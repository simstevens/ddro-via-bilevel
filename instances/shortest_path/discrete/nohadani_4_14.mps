...
COLUMNS
    ...
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  9.74
    x[0,3]    OBJ       1
    x[0,3]    primal_lower  3.3
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  6.67
    x[1,3]    OBJ       1
    x[1,3]    primal_lower  1.94
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  3.51
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  8.05
    x[2,3]    OBJ       1
    x[2,3]    primal_lower  2.45
    x[3,0]    OBJ       1
    x[3,0]    primal_lower  4.54
    x[3,1]    OBJ       1
    x[3,1]    primal_lower  8.69
    x[3,2]    OBJ       1
    x[3,2]    primal_lower  3.88
