...
COLUMNS
    ...
    x[0,1]    OBJ       1
    x[0,1]    primal_lower  0.26
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  3.77
    x[0,3]    OBJ       1
    x[0,3]    primal_lower  6.51
    x[1,0]    OBJ       1
    x[1,0]    primal_lower  3.17
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  4.86
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  2.24
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  4.18
    x[2,3]    OBJ       1
    x[2,3]    primal_lower  1.76
    x[3,0]    OBJ       1
    x[3,0]    primal_lower  1.85
    x[3,2]    OBJ       1
    x[3,2]    primal_lower  7.34
