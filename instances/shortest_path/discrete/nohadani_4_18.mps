...
COLUMNS
    ...
    x[0,1]    OBJ       1
    x[0,1]    primal_lower  2.62
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  1.63
    x[0,3]    OBJ       1
    x[0,3]    primal_lower  2.81
    x[1,0]    OBJ       1
    x[1,0]    primal_lower  5.79
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  4.93
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  3.46
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  3.3
    x[2,3]    OBJ       1
    x[2,3]    primal_lower  0.09
    x[3,0]    OBJ       1
    x[3,0]    primal_lower  1.48
    x[3,2]    OBJ       1
    x[3,2]    primal_lower  1.07
