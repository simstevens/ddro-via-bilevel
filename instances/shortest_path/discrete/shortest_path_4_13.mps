...
COLUMNS
    ...
    x[0,1]    OBJ       1
    x[0,1]    primal_lower  0.91
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  9.52
    x[0,3]    OBJ       1
    x[0,3]    primal_lower  4.74
    x[1,0]    OBJ       1
    x[1,0]    primal_lower  2.38
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  5.21
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  2.8
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  8.45
    x[2,3]    OBJ       1
    x[2,3]    primal_lower  0.4
    x[3,0]    OBJ       1
    x[3,0]    primal_lower  1.06
    x[3,2]    OBJ       1
    x[3,2]    primal_lower  7.52
