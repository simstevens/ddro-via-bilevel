...
COLUMNS
    ...
    x[0,1]    OBJ       1
    x[0,1]    primal_lower  4.95
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  2.28
    x[1,0]    OBJ       1
    x[1,0]    primal_lower  2.55
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  3.96
    x[1,3]    OBJ       1
    x[1,3]    primal_lower  3.77
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  9.97
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  4.08
    x[2,3]    OBJ       1
    x[2,3]    primal_lower  7.72
    x[3,1]    OBJ       1
    x[3,1]    primal_lower  7.61
    x[3,2]    OBJ       1
