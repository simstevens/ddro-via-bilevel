...
COLUMNS
    ...
    x[0,1]    OBJ       1
    x[0,1]    primal_lower  5.11
    x[0,2]    OBJ       1
    x[0,2]    primal_lower  4.42
    x[1,0]    OBJ       1
    x[1,0]    primal_lower  2.25
    x[1,2]    OBJ       1
    x[1,2]    primal_lower  6.31
    x[2,0]    OBJ       1
    x[2,0]    primal_lower  0.1
    x[2,1]    OBJ       1
    x[2,1]    primal_lower  11.79
